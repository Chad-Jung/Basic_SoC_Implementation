...
# Generated on: Tue Aug 18 09:55:36 KST 2026 (Tue Aug 18 00:55:36 UTC 2026)
...
set logfile fv/_4_BIT_SHIFT_REGISTER/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/_4_BIT_SHIFT_REGISTER -revised fv_map
...
add_search_path /home/hah014/Basic_SoC_Implementation/3_SYN/4_SAMPLE_RTL -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k _4_BIT_SHIFT_REGISTER.v
elaborate_design -golden -root {_4_BIT_SHIFT_REGISTER} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/_4_BIT_SHIFT_REGISTER/fv_map.v.gz
elaborate_design -revised -root {_4_BIT_SHIFT_REGISTER}
...
#add_name_alias fv/_4_BIT_SHIFT_REGISTER/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points._4_BIT_SHIFT_REGISTER.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag._4_BIT_SHIFT_REGISTER.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector._4_BIT_SHIFT_REGISTER.rtl.fv_map.rpt
