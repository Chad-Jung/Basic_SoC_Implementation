...
# Generated on: Wed Jul 08 03:11:18 KST 2026 (Tue Jul 07 18:11:18 UTC 2026)
...
set logfile fv/decoder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
add_search_path /home/hah014/Basic_SoC_Implementation/1_RTL/4_COMB_LOGIC/3_DECODER -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah014/Basic_SoC_Implementation/1_RTL/4_COMB_LOGIC/3_DECODER/decoder.v
...
set_system_mode lec
write_compared_points noneq.compared_points.decoder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.decoder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.decoder.rtl.fv_map.rpt
